...
public class TermsConditionsActivity extends DooitActivity {
    ...
    @BindView(R.id.activity_terms_conditions_web_progress)
    ...
    public static class Builder extends DooitActivityBuilder<TermsConditionsActivity.Builder> {
        ...
        public TermsConditionsActivity.Builder setTitle(String title) {
            intent.putExtra(INTENT_TITLE, title);
            return this;
        }

        public TermsConditionsActivity.Builder setUrl(String url) {

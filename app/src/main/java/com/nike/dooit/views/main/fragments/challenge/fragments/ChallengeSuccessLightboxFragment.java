...
public class ChallengeSuccessLightboxFragment extends DialogFragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setStyle(DialogFragment.STYLE_NO_FRAME, R.style.AppTheme_PopupOverlay_Semitransparent_Dark);
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(
                success ? R.layout.fragment_challenge_right : R.layout.fragment_challenge_wrong,
                container,
                false
        );

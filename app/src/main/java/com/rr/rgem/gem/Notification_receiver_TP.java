 ...
 */
public class Notification_receiver_TP extends BroadcastReceiver {

    public void onReceive(Context context, Intent intent) {

        String myContentTitle = context.getResources().getString(R.string.app_name);
        String myContentText = context.getResources().getString(R.string.Progress_Tracked_receiver_Text);

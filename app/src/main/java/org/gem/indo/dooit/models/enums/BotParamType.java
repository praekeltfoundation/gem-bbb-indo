...
public enum BotParamType {
    ...
    GOAL_ACTUAL_TARGET("goal.actual_target"),
    ...
    GOAL_EARLY_COMPLETION_DAYS("goal.goalCompletionPriorDays"),
    ...
    GOAL_WEEKS_DOWN_EARLY_COMPLETE("goal.weeks_down_early_complete"),
    GOAL_REMAINDER_DAYS_EARLY_COMPLETE("goal.remainder_days_early_complete"),
    ...
    GOAL_PROBLEM_GOALS("problem_goals"),
